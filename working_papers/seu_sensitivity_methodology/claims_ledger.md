...
| C10 | 7.5.2 | Claude × insurance: medians ≈ {71,53,73,71,55}; slope median ≈ −3.6, 90% CI ≈ [−54,39], P(slope<0) ≈ 0.56 | `claude_insurance_study/01_claude_insurance_study.qmd` | template (§7.1b) | computed |
