...
| C18 | 5.5 / 5.6 / 7.2 / 7.4 | Design-conditional information diagnostics. (i) Foundational lottery-spanning check: contrast rank 2 = K−1, nonzero singular values 1.08/0.67 (Prop 5.2 hypothesis verified). (ii) β contrast-Jacobian rank: foundational rank 10 = (K−1)D at all 20 prior draws → β locally identified mod gauge; applications rank 29 < 64 (K=3) / 96 (K=4) dof → β not identified. (iii) Application feature matrices full row rank 30 (D=32 ≥ R=30). (iv) Prior-predictive within-menu η-gap medians: foundational ≈ 0.52; insurance ≈ 0.18–0.20; Ellsberg ≈ 0.10–0.12. (v) α contraction: posterior sd(log α) 0.21–0.29 vs prior 0.75 across all 20 fits | `spikes/report_design_diagnostics_spike.py` → `report_design_diagnostics_results.json` (seed 20260705) | ranks, singular values, η-gap and contraction summaries | computed |
