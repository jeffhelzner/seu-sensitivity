/**
 * Data Simulation Model for m_02
 *
 ...
 * at runtime differ between m_0 and m_02.
 *
 * For m_02 the intended inputs are alpha_mean=3.5, alpha_sd=0.75
 * (i.e. lognormal(3.5, 0.75), calibrated via prior predictive
