"""
Choice Collector for the Ellsberg Study.

Sends choice prompts for each problem x presentation x temperature,
using assessment texts (not raw alternative descriptions) so that the
...
class ChoiceCollector:
    ...
    For each problem x presentation x temperature, the choice prompt is
    ...
    def collect_temperature(
        ...
        *,
        ...
        """
        Collect choices for all problems x presentations at one temperature.
        ...
        for problem in problems:
            alternative_ids = problem["alternative_ids"]
            ...
            for pres in problem["presentations"]:
                ...
                if assessments is not None:
                    ...
                    list_str = self.generator.format_choice_alternatives_list(
                        ordered_ids
                    )
                ...
                if parsed is not None:
                    position_chosen = parsed
                    alternative_chosen = ordered_ids[parsed - 1]
                    valid = True
                    valid_count += 1
                else:
