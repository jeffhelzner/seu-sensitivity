/**
 * Bayesian Decision Theory Model (m_3)
 * 
 * Extends m_1 by introducing a proportional relationship between
 * sensitivity under risk and sensitivity under uncertainty:
 ...
 * 
 * When kappa = 1, this reduces to m_1 (shared alpha).
 * When kappa != 1, risky sensitivity differs proportionally from uncertain.
 * 
 ...
 * - Shared: same utility function (upsilon/delta)
 */
data {
