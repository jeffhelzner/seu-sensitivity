...
3. **SBC by proxy.** SBC was inherited from the initial study rather than re-run with Claude-generated data. While SBC validates the computational algorithm (which is model-structural, not data-source-specific), the parameter recovery analysis provides direct validation under this study's conditions.
