...
The "Pattern" labels in @tbl-monotonicity use the following calibrated vocabulary (used consistently across the three cell reports and this synthesis):
