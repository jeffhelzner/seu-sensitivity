/**
 * Bayesian Decision Theory Model (m_2)
 * 
 * Extends m_1 by allowing separate sensitivity parameters for
 * uncertain and risky decisions:
 *   - alpha: sensitivity for uncertain choices
 *   - omega: sensitivity for risky choices (independent of alpha)
 * 
 ...
 * - Separate: alpha (uncertain) vs omega (risky) sensitivity
 */
data {
