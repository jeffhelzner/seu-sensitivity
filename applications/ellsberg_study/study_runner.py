"""
Study Runner — main pipeline orchestration for the Ellsberg Study.
...
class EllsbergStudyRunner:
    """
    End-to-end pipeline for the Ellsberg study.

    Instantiate with a StudyConfig, then call run().
    """
    ...
    def run(
        ...
        *,
        ...
        Args:
            skip_collection: If True, skip Phases 1-2 and load existing data.
    ...
    def fit_only(self) -> Dict[str, Any]:
        """Run Phase 4 on existing Stan data files."""
