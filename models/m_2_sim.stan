...
data {
  ...
  real<lower=0> omega_mean;       // mean for log(omega) (default=0)
  real<lower=0> omega_sd;         // sd for log(omega) (default=1)
...
generated quantities {
  ...
  real omega = lognormal_rng(omega_mean, omega_sd);
  ...
  // Generate choices for risky problems (using omega)
  array[N] int z;
