/**
 * Bayesian Decision Theory Model (m_02) for Simulation Based Calibration
 *
 * Structurally identical to m_0_sbc.  Differs only in the alpha
 * prior: lognormal(3.5, 0.75), calibrated via prior predictive
 * analysis for the Ellsberg study with K=4 consequences
 * (see scripts/run_prior_predictive_grid.py and
 * results/prior_predictive/grid_search_ellsberg/).
 *
...
transformed data {
  ...
  real<lower=0> alpha_ = lognormal_rng(3.5, 0.75);
