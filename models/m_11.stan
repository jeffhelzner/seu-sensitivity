/**
 * Bayesian Decision Theory Model (m_11)
 *
 * Structurally identical to m_1.  Differs only in the prior
 ...
 *   prior-implied SEU-max rate ≈ 0.77 (uncertain), 0.86 (risky)
 *
 * See scripts/run_prior_predictive_grid_augmented.py and
 * results/prior_predictive/augmented_grid_search/m_1/ for calibration.
 */
data {
