"""
Study Runner for the Claude × Insurance Study (Cell 2,1).

Thin wrapper around the temperature study pipeline, using this module's
config (Anthropic provider, Claude temperature grid).
"""
...
# Reuse all task-level components from temperature study
...
class ClaudeInsuranceStudyRunner:
    """
    End-to-end pipeline for the Claude × Insurance study.

    Same 4-phase structure as TemperatureStudyRunner but configured
    for Anthropic Claude on the insurance claims task.
    """
